            ...
            return(<div key={ship.id} style={{borderBottom:`1px solid ${col}10`}}>
              ...
              {!shipCol&&<div style={{padding:"0 16px 16px"}}>
                ...
                {ship.bookings.length>0&&<div style={{marginTop:8}}>
                  <p style={{fontSize:10,fontWeight:600,color:"#94A3B8",textTransform:"uppercase",marginBottom:6}}>Bookings neste navio ({ship.bookings.length})</p>
                  {ship.bookings.map(b=>{const bD=b.deadlineCarga?dUntil(b.deadlineCarga):null;const bA=armCfg?.ddlDays>0&&bD!==null&&bD<=armCfg.ddlDays&&bD>=0;const bSobra=(b.qtdTotal||0)-(b.qtdUsando||0);
                    return(<div key={b.id} style={{padding:"12px 14px",borderRadius:10,background:bA?"#FEF2F2":`${col}04`,border:`1px solid ${bA?"#FECACA":`${col}15`}`,marginBottom:6}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:4,marginBottom:6}}>
                        ...
                        <div style={{padding:4,borderRadius:4,background:"#DBEAFE",textAlign:"center"}}><p style={{fontSize:7,color:"#94A3B8",textTransform:"uppercase"}}>Total</p><p style={{fontSize:12,fontWeight:700,color:"#1D4ED8"}}>{b.qtdTotal||0}</p></div>
